...
class Individual(list, IndividualLike):
    ...
    def __init__(self, iterable: Optional[Iterable] = None,
            name: Optional[str] = None,
                 fitness: Optional[FitnessLike] = None, features: Optional[FeaturesLike] = None, valid = True, ss = None) -> None:
        ...
        self.valid = valid if valid is not None else True
        self.ss = ss if valid is not None else None
        self.novelty = 0
