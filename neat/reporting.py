...
class BaseReporter(object):
    ...
    def post_evaluate(self, config, population, species, best_genome, p_valid):
        pass
...
class StdOutReporter(BaseReporter):
    ...
    def post_evaluate(self, config, population, species, best_genome):
        ...
        safety_scores = [c.ss for c in population.values()]
        fit_mean = mean(fitnesses)
        ss_mean = mean(safety_scores)
        ...
        p_valid = valid/len(population.values())
        print('Population\'s average fitness: {0:3.5f} stdev: {1:3.5f}'.format(fit_mean, fit_std))
        print('Population\'s average safety_score: {}'.format(ss_mean))
        print('P_valid: {}'.format(p_valid))
        print('qd_score_ss: {}'.format(qd_score_ss))
        print(
